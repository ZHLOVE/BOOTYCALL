...
//  XHRadarView
//
//  Created by Lours on 16/8/10.
//  Copyright (c) 2016年 邱Lours豪. All rights reserved.
//
...
#define INDICATOR_START_COLOR       [UIColor colorWithRed:245/255.0 green:131/255.0 blue:103/255.0 alpha:0.2]
...
//        _textLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, self.center.y - self.radius, self.bounds.size.width, 30)];
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.textLabel) {
        self.textLabel.frame = CGRectMake(0, self.center.y - ([UIScreen mainScreen].bounds.size.height)/3.2, rect.size.width, 30);
