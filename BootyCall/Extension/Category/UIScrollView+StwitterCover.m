...
@implementation UIScrollView (StwitterCover)

- (void)setTwitterCoverView:(STwitterCoverView *)twitterCoverView {
...
- (STwitterCoverView *)twitterCoverView {
...
{
    STwitterCoverView *view = [[STwitterCoverView alloc] initWithFrame:CGRectMake(0,0, SCREEN_WIDTH, CHTwitterCoverViewHeight) andContentTopView:topView];    
...
@implementation STwitterCoverView
{
