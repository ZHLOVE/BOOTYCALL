...
- (void)commonInit
{
    ...
    _inputPlaceHolderTextColor = [UIColor blackColor];
    ...
    _selTextColor = [UIColor blackColor];
...
-(void)layoutTagviews {
    ...
    if (_type==TTTagView_Type_Edit) {
        ...
        _tfInput.layer.cornerRadius = 3.f;//_tfInput.frame.size.height * 0.5f;
...
- (TTCheckBoxButton *)tagButtonWithTag:(NSString *)tag {
    ...
    tagBtn.layer.cornerRadius = 3.f;//btnFrame.size.height * 0.5f;
