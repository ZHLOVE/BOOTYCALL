...
- (void)drawRect:(CGRect)rect {
    ...
    //[self.text drawAtPoint:CGPointMake(x, y) withAttributes:@{NSStrokeWidthAttributeName:self.font}];
    if (_timer) {
        ...
        [self.text drawAtPoint:CGPointMake(x, y) withFont:self.font];
        //[self.text drawAtPoint:CGPointMake(x, y) withAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:16]}];
    }
}
