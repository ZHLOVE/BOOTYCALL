...
//        创建信号量
        ...
        // 头像和昵称
        //从本地获取
      __block  NSString *nickName = [SCUserProfileEntity getNickNameWithUsername:conversation.chatter];
        __block   NSString *avatarURLPath = [SCUserProfileEntity getavatarURLPathWithUsername:conversation.chatter];
//        NSLog(@"name%@",conversation.chatter);
        if (nickName && avatarURLPath) {
            ...
            [MResponseUserInfo responseUserInfoWithId:conversation.chatter ResponseUserCompletion:^(BOOL success, NSError *error, NSDictionary *currentUserInfo) {
                [SCUserProfileEntity saveUserProfileWithUsername:conversation.chatter forNickName:currentUserInfo[@"myInfo"][@"nickName"] avatarURLPath:nil];
                //保存到本地后，从本地获取
                ...
                if (avatarURLPath) {
                    ...
                    [SCUserProfileEntity saveUserProfileWithUsername:conversation.chatter forNickName:nickName avatarURLPath:currentUserInfo[@"albumArray"][0]];
